...
**[!UICONTROL Observe Daylight Savings Time]:** beschouwt zomertijd in de gerapporteerde tijden.
...
* **[!UICONTROL Previous N days]:** Bevat gegevens voor een bepaald aantal dagen vóór vandaag.

* **[!UICONTROL Custom]:** Bevat gegevens tussen specifieke begin- en einddatums. Selecteer **[!UICONTROL Present]** om gegevens tot en met de vorige dag te rapporteren.
...
\* *[!UICONTROL Account]* is alleen beschikbaar voor de volgende rapporttypen wanneer uw organisatie is geconfigureerd voor [cross-account reporting](report-about.md#cross-account-reporting):  [!UICONTROL Custom], [!UICONTROL Site], [!UICONTROL Segment], [!UICONTROL Geo], [!UICONTROL Device], [!UICONTROL Frequency (by Impression)] en [!UICONTROL Conversion]. Neem contact op met uw Adobe-accountmanager voor meer informatie over rapportage via een account op andere accounts.

Ga als volgt te werk om een of meer filters toe te passen:

* Selecteer een dimensie, selecteer de exploitant (*equals* of *not equals*), en selecteer dan de toepasselijke waarde. Als u bijvoorbeeld alleen gegevens wilt retourneren voor preroll-advertenties, geeft u &quot;[!UICONTROL Ad Type equals Preroll]&quot; op.
...
**[!UICONTROL Format]:** Of om een rapport in  *[!UICONTROL CSV]* (komma-gescheiden waarden) of  *[!UICONTROL Tab]* (lusje-gescheiden waarden) formaat te produceren.
...
* *[!UICONTROL Last Event]:* Kenmerkt omzettingen in de laatste klik of de indruk in de omzettingsweg.
...
* *[!UICONTROL Even Distribution]:* Kenmerken conversies zijn gelijk aan elke gebeurtenis in het conversiepad.
...
* *[!UICONTROL First Event]:* Kenmerkt omzettingen in de eerste klik of de indruk in de omzettingsweg.

* *[!UICONTROL U-shaped]:* Kenmerken de omzetting aan alle gebeurtenissen in de omzettingsweg maar geeft het meeste gewicht aan de eerste en laatste gebeurtenissen, met opeenvolgend minder gewicht aan de gebeurtenissen in het midden van de omzettingsweg.

* *[!UICONTROL Display Only]:*  Kenmerken conversies naar de laatste DSP klik of indruk in het conversiepad. Dit omvat video en aangesloten tv-advertenties en sluit kliks op Advertising Cloud Search-advertenties uit.

* *[!UICONTROL Social Only]:* Verouderd

<!-- See also [How Attribution Rules Are Calculated for Adobe Advertising Cloud](). -->

**[!UICONTROL Paths as Columns]:**  (Alle  [!UICONTROL Custom],  [!UICONTROL Conversion],  [!UICONTROL Device],  [!UICONTROL Geo],  [!UICONTROL Segment], en  [!UICONTROL Site] rapporten met  [!UICONTROL Conversion Metrics] of  [!UICONTROL Custom Goals] kolommen) Welke types van omzettingen om te melden wanneer de vroegere gebeurtenissen op het zelfde apparaat voorkwamen. U kunt maximaal drie typen opnemen. Voor elk geselecteerd type, is een afzonderlijke kolom inbegrepen voor elke omzettingsmetrisch en met het gespecificeerde achtervoegsel ([!UICONTROL (tl)], [!UICONTROL (ct)], of [!UICONTROL (vt)]) toegevoegd:

* *[!UICONTROL Total (TL) = CT + VT \* VT weight]:* Omvat omzettingen die aan kliks (CT voor klik-door) en aan impressies (VT voor mening-door) worden toegeschreven. Conversies die worden toegewezen aan impressies worden vermenigvuldigd met het opgegeven doorkijkgewicht. Het standaardgezichtsdoorsgewicht is 100%, wat betekent dat omzettingen die aan indrukkingen worden toegeschreven, worden geteld als 100% van de waarde van omzettingen die aan kliks worden toegeschreven.
...
Meer informatie over [oplossingen voor verschillende apparaten](/help/dsp/introduction/features/cross-device-solutions.md).
...
* *[!UICONTROL Total People (TP)]:* Omvat de totale omzettingen, die zowel de omzettingen van het zelfde apparaat als de omzettingen van het dwars-apparaat omvatten (indien van toepassing). In het rapport wordt &quot;[!UICONTROL (tp)]&quot;toegevoegd aan de metrische naam en het regeltype van de omzetting.

* *[!UICONTROL Same Device (SD)]:* Omvat slechts omzettingen waarvoor slechts één enkel apparaat in de omzettingsweg werd gevolgd. In het rapport wordt &quot;[!UICONTROL (sd)]&quot;toegevoegd aan de metrische naam en het regeltype van de omzetting.

* *[!UICONTROL Cross Device (XD)]:* Omvat slechts omzettingen waarvoor meer dan één apparaat in de omzettingsweg werd gevolgd. In het rapport wordt &quot;[!UICONTROL (xd)]&quot;toegevoegd aan de metrische naam en het regeltype van de omzetting.

**[!UICONTROL Conversion Reporting Based On]:**  Hoe te om omzettingsgegevens te melden:

* *[!UICONTROL Conversion Timestamp]:* (De standaardwaarde) Conversies worden gekoppeld aan de conversiedatum.

* *[!UICONTROL Event Timestamp]:* Conversies worden gerapporteerd op basis van de datum van de indruk of klik die de omzetting heeft veroorzaakt, zoals bepaald door het opgegeven  [!UICONTROL Attribution Rule Settings].

## [!UICONTROL Add Email Recipients] Sectie

**[!UICONTROL Email]:** E-mailadres(sen) waarnaar ingevulde rapporten of meldingen moeten worden verzonden als het rapport wegens fouten is geannuleerd. Als u meerdere adressen wilt opgeven, scheidt u deze met komma&#39;s of spaties.
...
**[!UICONTROL Send & Save]:** Wanneer wordt het rapport verzonden:  *[!UICONTROL On Schedule]* of  *[!UICONTROL Run Now]*. Geplande rapporten zullen tegen 9:00 in de tijdzone van de rekening worden geleverd.

>[!NOTE]
>
>U kunt [een douanerapport op elk ogenblik in werking stellen](report-run-now.md) van de [!UICONTROL Reports] mening.
