...
Het is belangrijk om te begrijpen of het doel van de campagne het hoogst mogelijke ROAS of het laagst mogelijke CPA is te bereiken. Voor elk pakket in de campagne, zult u het objectieve doel dienovereenkomstig als of *[!UICONTROL Highest ROAS - Custom Goal]* of *[!UICONTROL Lowest CPA - Custom Goal]* specificeren.

![optimalisatiedoel](/help/dsp/assets/optimization-goals.png)

U moet ook de succesgebeurtenis(sen) bepalen die tot het algemene doel zullen leiden en dienovereenkomstig douanedoelstellingen creëren. Voor elk pakket, zult u een douanedoel specificeren dat met het algemene optimalisatiedoel voor rapportering en algoritmische optimalisering moet worden gebruikt gebruikend [!DNL Adobe Sensei]. Voor meer informatie over het creëren van douanedoelstellingen, zie [Beste praktijken voor het Bouwen van een Doel van de Douane](custom-goal-best-practices.md).
...
* Het gebruik van looppas van netwerk (RON) richtend: Het is belangrijk om een looppas van netwerkplaatsing te omvatten zonder doelgericht publiek en met brede inventarisgericht. Hierdoor kan het algoritme [!DNL Adobe Sensei] waardevolle gebruikers vinden die nieuwere cookies kunnen hebben die nog niet in een publiek zijn gecategoriseerd.
...
* **Pacing &amp; Capping:** Om een CPA of ROAS optimaliseringsdoel te selecteren, moet het pakket pakket-vlakke het verpakken gebruiken. Dit zorgt ervoor dat alle plaatsen binnen het pakket worden geoptimaliseerd om uitgaven op basis van prestaties en schaal aan de geselecteerde doelstellingen te verdelen.

* **Vluchtdatums:** (Verkenningspakketten) Gebruik de  [!UICONTROL Activate Custom Flighting] functie als uw campagne langer dan 25 dagen wordt uitgevoerd. Stel eerst een aangepaste vlucht voor de eerste 10 dagen in op ongeveer 75% van de dagelijkse begroting die nodig is om de uitgaven tijdens de *leerfase te verlagen*. Stel vervolgens een tweede aangepaste vlucht in voor de rest van de begroting.
...
* **Aangepaste doelen:**
   ...
   * Voer de desbetreffende [!UICONTROL Target CPA] of [!UICONTROL Target ROAS] in.

* **Vullingstrategie plaatsen:** selecteer deze optie  *[!UICONTROL Even]* om uw prestatiedoelen te maximaliseren door de hele vluchtdatum op dezelfde manier te doorlopen.

   Gebruik *[!UICONTROL FrontLoad]* en *[!UICONTROL Aggressive Front Load]* slechts het verpakken wanneer u volledig voorrang geeft aan levering en besteedt over prestatiesoptimalisering omdat die strategieën negatieve gevolgen voor uw gewenste prestaties KPIs kunnen hebben.
...
Zorg er ook voor dat u elke plaatsing aan een pakket toevoegt met het doeltype van het pakket *[!UICONTROL Prospecting]* of *[!UICONTROL Retargeting]*, al naar gelang het geval.
...
* **Filters vóór bod:** Minimaliseer of vermijd bij voorkeur agressieve filters vóór het bieden, die voorkomen dat de plaatsing schaalbaar wordt. De beste praktijken omvatten het volgende:
...
Zie de beschrijvingen van wanneer elk vooraf geboden filter op [Plaatsingsniveau pre-Bodfilters en hoe te om hen te gebruiken](/help/dsp/optimization/optimization-pre-bid-filters.md).

### Inventaris

Om schaal te maximaliseren, gebruik [!UICONTROL Public] (Open Uitwisseling) en [!UICONTROL On Demand] voorraad.
...
* **[!UICONTROL Device Targeting]**:
   * Omvat [!UICONTROL Computer], [!UICONTROL Mobile], en [!UICONTROL Tablet].
   * Niet richten [!UICONTROL Firefox] en [!UICONTROL Safari] wegens het richten en metingsbeperkingen. Neem contact op met uw Adobe-accountmanager voor meer informatie over [!DNL Adobe]-ondersteuning voor [!DNL Safari ITP].
...
Door contextafhankelijke filters, het blokkeren van voorbiedingsfraude en/of het filteren van [!UICONTROL Ads.txt] wordt de schaal van uw plaatsingen beperkt, maar worden deze indien nodig gebruikt.
...
* Zorg ervoor dat alle plaatsen *ten minste* alle primaire display en formaten (300x250, 728x90, 160x600, 300x600, 320x50 en 300x50) bevatten.
