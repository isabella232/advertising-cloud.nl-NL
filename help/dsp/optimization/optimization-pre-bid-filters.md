...
| [!UICONTROL Viewability IAS] | Hiermee stelt u een minimaal weergavepercentage in, waarbij gebruik wordt gemaakt van historische gegevens van [!DNL IAS]. Je kunt een bod uitbrengen als de opgegeven drempel is bereikt. | Dit filter werkt het best aangezien meer gegevens binnen door een campagne-niveau [!DNL IAS] integratie worden getrokken.<br><br>Wanneer de campagne wordt gevormd om  [!DNL IAS] gegevens te gebruiken, is de beste praktijken deze filter met het pakketoptimaliseringsdoel &quot;[!UICONTROL Lowest vCPM (IAS)].&quot;te gebruiken. Als de integratie niet wordt toegelaten, gebruik dit filter met het optimalisatiedoel &quot;[!UICONTROL Lowest CPM]&quot;. |
| [!UICONTROL Viewability Moat] | Hiermee stelt u een minimaal weergavepercentage in, waarbij gebruik wordt gemaakt van historische gegevens van [!DNL Moat]. Je kunt een bod uitbrengen als de opgegeven drempel is bereikt. | Dit filter werkt het best aangezien meer gegevens binnen door een campagne-niveau [!DNL Moat] integratie worden getrokken.<br><br>Wanneer de campagne wordt gevormd om  [!DNL Moat] gegevens te gebruiken, is de beste praktijken het doel van pakketoptimalisering &quot;[!UICONTROL Lowest vCPM (Moat)].&quot;te gebruiken. Als de integratie niet wordt toegelaten, gebruik dit filter met het optimalisatiedoel &quot;[!UICONTROL Lowest CPM]&quot;. |
